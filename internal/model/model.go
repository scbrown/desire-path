...
// Invocation represents a single tool invocation from an AI coding assistant.
// Source-specific fields (hook_event, transcript_path, tool_use_id) belong in Metadata.
