...
func (f *fakeStore) RecordInvocation(context.Context, model.Invocation) error { return nil }
func (f *fakeStore) ListInvocations(context.Context, store.InvocationListOpts) ([]model.Invocation, error) {
	return nil, nil
}
